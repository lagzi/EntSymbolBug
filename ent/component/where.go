...
// SomeID applies equality check predicate on the "some_id" field. It's identical to SomeIDEQ.
func SomeID(v uint64) predicate.Component {
	return predicate.Component(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldSomeID), v))
	})
}
...
// SomeIDEQ applies the EQ predicate on the "some_id" field.
func SomeIDEQ(v uint64) predicate.Component {
	return predicate.Component(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldSomeID), v))
	})
}

// SomeIDNEQ applies the NEQ predicate on the "some_id" field.
func SomeIDNEQ(v uint64) predicate.Component {
	return predicate.Component(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldSomeID), v))
	})
}

// SomeIDIn applies the In predicate on the "some_id" field.
func SomeIDIn(vs ...uint64) predicate.Component {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Component(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldSomeID), v...))
	})
}

// SomeIDNotIn applies the NotIn predicate on the "some_id" field.
func SomeIDNotIn(vs ...uint64) predicate.Component {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Component(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldSomeID), v...))
	})
}

// SomeIDGT applies the GT predicate on the "some_id" field.
func SomeIDGT(v uint64) predicate.Component {
	return predicate.Component(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldSomeID), v))
	})
}

// SomeIDGTE applies the GTE predicate on the "some_id" field.
func SomeIDGTE(v uint64) predicate.Component {
	return predicate.Component(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldSomeID), v))
	})
}

// SomeIDLT applies the LT predicate on the "some_id" field.
func SomeIDLT(v uint64) predicate.Component {
	return predicate.Component(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldSomeID), v))
	})
}

// SomeIDLTE applies the LTE predicate on the "some_id" field.
func SomeIDLTE(v uint64) predicate.Component {
	return predicate.Component(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldSomeID), v))
	})
}

// HasPictures applies the HasEdge predicate on the "pictures" edge.
func HasPictures() predicate.Component {
	return predicate.Component(func(s *sql.Selector) {
...
func HasPicturesWith(preds ...predicate.Picture) predicate.Component {
	return predicate.Component(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
