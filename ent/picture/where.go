...
func HasPicture() predicate.Picture {
	return predicate.Picture(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(PictureTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, PictureTable, PicturePrimaryKey...),
		)
...
func HasPictureWith(preds ...predicate.User) predicate.Picture {
	return predicate.Picture(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
